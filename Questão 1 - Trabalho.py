...
#caso o usuário digite uma quantidade maior que 5 ira ter o desconto equivalente a 3%
    ...
    print(f'O valor a pagar sem desconto foi R${calculo}')
    print(f'O valor a pagar com desconto é R${calculo-(calculo * 0.03)}')

#caso o usuário digite uma quantidade maior que 19 ira ter o desconto equivalente a 6%
elif(quantidade <= 99):
    print(f'O valor a pagar sem desconto foi R${.format(calculo)}')
    print(f'O valor a pagar com desconto é R${calculo-(calculo * 0.06)}')
else:
    print(f'O valor a pagar sem desconto foi R${calculo)}')
    print(f'O valor a pagar com desconto é R${calculo - (calculo * 0.1)}')
